...
const Toast = (text: string): void => {
  ...
  // 无则有
  let vhMsgDom: any = document.querySelector(".byt-message");
  if (!vhMsgDom) {
    vhMsgDom = document.createElement("section");
    vhMsgDom.classList.add("byt-message");
